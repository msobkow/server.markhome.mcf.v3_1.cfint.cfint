// Description: Java 25 Object interface for CFInt TSecGrpInc.
...
{
	/**
	 *	Initially, the class code for an object is ICFSecTSecGrpInc.CLASS_CODE, but the Obj layer relies on class code translation to map those
	...
	/**
	 *	Get the ICFSecTSecGrpInc instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFSecTSecGrpInc instance which currently backs this object.
	 */
	ICFSecTSecGrpInc getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFSecTSecGrpInc value );
	 ...
	 *	@return	ICFSecTSecGrpInc instance which currently backs this object.
	 */
	ICFSecTSecGrpInc getTSecGrpIncRec();
