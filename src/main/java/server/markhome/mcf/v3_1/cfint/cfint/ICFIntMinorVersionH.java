// Description: Java 25 interface for a MinorVersion history object
...
/**
 *	ICFIntMinorVersionH provides access to history records matching the CFIntMinorVersion object change history.
 */
public interface ICFIntMinorVersionH
{
