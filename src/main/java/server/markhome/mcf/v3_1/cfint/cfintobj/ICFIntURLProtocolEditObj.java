// Description: Java 25 Instance Edit Object interface for CFInt URLProtocol.
...
public interface ICFIntURLProtocolEditObj
	extends ICFIntURLProtocolObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFIntURLProtocolObj.
	 */
	ICFIntURLProtocolObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFIntURLProtocolObj.
	 */
	ICFIntURLProtocolObj getOrigAsURLProtocol();
	 ...
	 */
	ICFIntURLProtocolObj create();

	/*
	 *	Update the instance.
	 */
	CFIntURLProtocolEditObj update();

	/*
	 *	Delete the instance.
	 */
	CFIntURLProtocolEditObj deleteInstance();
	...
	/**
	 *	Set the required int attribute URLProtocolId.
	 *
	 *	@param value The required int attribute URLProtocolId value to be applied.
	 */
