// Description: Java 25 interface for a SubProject history object
...
/**
 *	ICFIntSubProjectH provides access to history records matching the CFIntSubProject object change history.
 */
public interface ICFIntSubProjectH
{
