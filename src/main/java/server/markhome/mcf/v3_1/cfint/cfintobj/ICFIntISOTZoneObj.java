// Description: Java 25 Object interface for CFInt ISOTZone.
...
public interface ICFIntISOTZoneObj
	extends ICFSecISOTZoneObj
{
	...
	/**
	 *	Get the ICFSecISOTZone instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFSecISOTZone instance which currently backs this object.
	 */
	ICFSecISOTZone getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFSecISOTZone value );
