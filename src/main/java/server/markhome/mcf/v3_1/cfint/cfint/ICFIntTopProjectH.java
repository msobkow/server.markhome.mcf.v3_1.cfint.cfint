// Description: Java 25 interface for a TopProject history object
...
/**
 *	ICFIntTopProjectH provides access to history records matching the CFIntTopProject object change history.
 */
public interface ICFIntTopProjectH
{
