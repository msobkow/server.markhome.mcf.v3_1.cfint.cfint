// Description: Java 25 interface for a MajorVersion history primary key object
...
/**
 *	ICFIntMajorVersionHPKey History Primary Key interface for MajorVersion
 *		requiredId	Required object attribute Id. */
public interface ICFIntMajorVersionHPKey
{
