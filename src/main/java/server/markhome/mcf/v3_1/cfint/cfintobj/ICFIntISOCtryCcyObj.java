// Description: Java 25 Object interface for CFInt ISOCtryCcy.
...
public interface ICFIntISOCtryCcyObj
	extends ICFSecISOCtryCcyObj
{
	/**
	 *	Initially, the class code for an object is ICFSecISOCtryCcy.CLASS_CODE, but the Obj layer relies on class code translation to map those
	...
	/**
	 *	Get the ICFSecISOCtryCcy instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFSecISOCtryCcy instance which currently backs this object.
	 */
	ICFSecISOCtryCcy getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFSecISOCtryCcy value );
	 ...
	 *	@return	ICFSecISOCtryCcy instance which currently backs this object.
	 */
	ICFSecISOCtryCcy getISOCtryCcyRec();
	...
	/**
	 *	Get the required ICFIntISOCcyObj instance referenced by the Ccy key.
	 *
	 *	@return	The required ICFIntISOCcyObj instance referenced by the Ccy key.
	 */
