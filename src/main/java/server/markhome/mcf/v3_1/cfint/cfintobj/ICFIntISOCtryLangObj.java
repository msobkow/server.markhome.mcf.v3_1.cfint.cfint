// Description: Java 25 Object interface for CFInt ISOCtryLang.
...
public interface ICFIntISOCtryLangObj
	extends ICFSecISOCtryLangObj
{
	/**
	 *	Initially, the class code for an object is ICFSecISOCtryLang.CLASS_CODE, but the Obj layer relies on class code translation to map those
	...
	/**
	 *	Get the ICFSecISOCtryLang instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFSecISOCtryLang instance which currently backs this object.
	 */
	ICFSecISOCtryLang getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFSecISOCtryLang value );
	 ...
	 *	@return	ICFSecISOCtryLang instance which currently backs this object.
	 */
	ICFSecISOCtryLang getISOCtryLangRec();
	...
	/**
	 *	Get the required ICFIntISOCtryObj instance referenced by the Ctry key.
	 *
	 *	@return	The required ICFIntISOCtryObj instance referenced by the Ctry key.
	 */
	...
	/**
	 *	Get the required ICFIntISOLangObj instance referenced by the Lang key.
	 *
	 *	@return	The required ICFIntISOLangObj instance referenced by the Lang key.
	 */
