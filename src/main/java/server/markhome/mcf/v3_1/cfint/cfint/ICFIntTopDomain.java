// Description: Java 25 interface for a TopDomain record implementation
...
public interface ICFIntTopDomain
{
	...
	public static final String S_TLDID_INIT_VALUE = "$switch HasInitValue yes InitValue default Zero256bits$";
