// Description: Java 25 interface for a SubProject history primary key object
...
/**
 *	ICFIntSubProjectHPKey History Primary Key interface for SubProject
 *		requiredId	Required object attribute Id. */
public interface ICFIntSubProjectHPKey
{
