// Description: Java 25 Object interface for CFInt SecUser.
	...
	extends ICFSecSecUserObj
{
	...
	/**
	 *	Get the ICFSecSecUser instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFSecSecUser instance which currently backs this object.
	 */
	ICFSecSecUser getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFSecSecUser value );
