// Description: Java 25 Object interface for CFInt ISOLang.
...
{
	/**
	 *	Initially, the class code for an object is ICFSecISOLang.CLASS_CODE, but the Obj layer relies on class code translation to map those
	...
	/**
	 *	Get the ICFSecISOLang instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFSecISOLang instance which currently backs this object.
	 */
	ICFSecISOLang getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFSecISOLang value );
