// Description: Java 25 Object interface for CFInt TopDomain.
...
{
	/**
	 *	Initially, the class code for an object is ICFIntTopDomain.CLASS_CODE, but the Obj layer relies on class code translation to map those
	...
	/**
	 *	Get the ICFIntTopDomain instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFIntTopDomain instance which currently backs this object.
	 */
	ICFIntTopDomain getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFIntTopDomain value );
	 ...
	 *	@return	ICFIntTopDomain instance which currently backs this object.
	 */
	ICFIntTopDomain getTopDomainRec();
