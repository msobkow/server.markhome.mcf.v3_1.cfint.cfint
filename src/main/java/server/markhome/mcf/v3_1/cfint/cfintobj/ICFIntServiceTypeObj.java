// Description: Java 25 Object interface for CFInt ServiceType.
...
public interface ICFIntServiceTypeObj
	extends ICFSecServiceTypeObj
{
	/**
	 *	Initially, the class code for an object is ICFSecServiceType.CLASS_CODE, but the Obj layer relies on class code translation to map those
	...
	/**
	 *	Get the ICFSecServiceType instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFSecServiceType instance which currently backs this object.
	 */
	ICFSecServiceType getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFSecServiceType value );
	 ...
	 *	@return	ICFSecServiceType instance which currently backs this object.
	 */
	ICFSecServiceType getServiceTypeRec();
