// Description: Java 25 Instance Edit Object interface for CFInt ISOCtry.
...
public interface ICFIntISOCtryEditObj
	extends ICFIntISOCtryObj, ICFSecISOCtryEditObj
{
	/*
