// Description: Java 25 interface for a MimeType history object
...
/**
 *	ICFIntMimeTypeH provides access to history records matching the CFIntMimeType object change history.
 */
public interface ICFIntMimeTypeH
{
