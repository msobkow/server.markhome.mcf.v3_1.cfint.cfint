// Description: Java 25 Instance Edit Object interface for CFInt TopDomain.
...
public interface ICFIntTopDomainEditObj
	extends ICFIntTopDomainObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFIntTopDomainObj.
	 */
	ICFIntTopDomainObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFIntTopDomainObj.
	 */
	ICFIntTopDomainObj getOrigAsTopDomain();
	 ...
	 *	Delete the instance.
	 */
	CFIntTopDomainEditObj deleteInstance();
	...
	/**
	 *	Get a list ICFIntTopProjectObj instances referenced by the TopProject key.
	 *
	 *	@return	The (potentially empty) list of ICFIntTopProjectObj instances referenced by the TopProject key.
	 */
	List<ICFIntTopProjectObj> getOptionalComponentsTopProject();

	/**
	 *	Get a list ICFIntLicenseObj instances referenced by the License key.
	 *
	 *	@return	The (potentially empty) list of ICFIntLicenseObj instances referenced by the License key.
	 */
