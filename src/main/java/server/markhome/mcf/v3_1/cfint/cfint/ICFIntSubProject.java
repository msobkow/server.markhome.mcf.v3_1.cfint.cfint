...
public interface ICFIntSubProject
{
	...
	public static final String S_TOPPROJECTID_INIT_VALUE = "$switch HasInitValue yes InitValue default Zero256bits$";
	public static final CFLibDbKeyHash256 TOPPROJECTID_INIT_VALUE = CFLibDbKeyHash256.fromHex( S_TOPPROJECTID_INIT_VALUE );
