// Description: Java 25 interface for a URLProtocol history object
...
/**
 *	ICFIntURLProtocolH provides access to history records matching the CFIntURLProtocol object change history.
 */
public interface ICFIntURLProtocolH
{
