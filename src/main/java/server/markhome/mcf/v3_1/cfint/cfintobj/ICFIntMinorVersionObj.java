// Description: Java 25 Object interface for CFInt MinorVersion.
...
{
	/**
	 *	Initially, the class code for an object is ICFIntMinorVersion.CLASS_CODE, but the Obj layer relies on class code translation to map those
	...
	/**
	 *	Get the ICFIntMinorVersion instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFIntMinorVersion instance which currently backs this object.
	 */
	ICFIntMinorVersion getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFIntMinorVersion value );
	 ...
	 *	@return	ICFIntMinorVersion instance which currently backs this object.
	 */
	ICFIntMinorVersion getMinorVersionRec();
