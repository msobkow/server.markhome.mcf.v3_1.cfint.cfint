// Description: Java 25 interface for a MajorVersion history object
...
/**
 *	ICFIntMajorVersionH provides access to history records matching the CFIntMajorVersion object change history.
 */
public interface ICFIntMajorVersionH
{
