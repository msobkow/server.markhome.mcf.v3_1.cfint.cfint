// Description: Java 25 Instance Edit Object interface for CFInt Tld.
...
public interface ICFIntTldEditObj
	extends ICFIntTldObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFIntTldObj.
	 */
	ICFIntTldObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFIntTldObj.
	 */
	ICFIntTldObj getOrigAsTld();
	 ...
	 *	Update the instance.
	 */
	CFIntTldEditObj update();

	/*
	 *	Delete the instance.
	 */
	CFIntTldEditObj deleteInstance();
	...
	/**
	 *	Get a list ICFIntTopDomainObj instances referenced by the TopDomain key.
	 *
	 *	@return	The (potentially empty) list of ICFIntTopDomainObj instances referenced by the TopDomain key.
	 */
