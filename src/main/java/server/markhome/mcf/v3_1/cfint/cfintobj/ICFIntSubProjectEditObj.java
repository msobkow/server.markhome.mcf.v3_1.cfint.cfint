// Description: Java 25 Instance Edit Object interface for CFInt SubProject.
	...
	extends ICFIntSubProjectObj
{
	...
	/**
	 *	Get a list ICFIntMajorVersionObj instances referenced by the MajorVer key.
	 *
	 *	@return	The (potentially empty) list of ICFIntMajorVersionObj instances referenced by the MajorVer key.
	 */
